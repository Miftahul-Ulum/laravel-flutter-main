    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Dashboard FIC 7 - ID Cloud Host x helloulum</h1>
            </div>
            <div class="row">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">helloulum</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">helloulum<div class="bullet"></div> 8 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
